...
return [
    ...
    'connections' => [
        ...
        'revamp' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_REVAMP_HOST', '127.0.0.1'),
            'port' => env('DB_REVAMP_PORT', '3306'),
            'database' => env('DB_REVAMP_DATABASE', 'revamp_db'),
            'username' => env('DB_REVAMP_USERNAME', 'root'),
            'password' => env('DB_REVAMP_PASSWORD', ''),
